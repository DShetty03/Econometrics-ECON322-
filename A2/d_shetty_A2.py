...
print(f"Mean values of height:{mean_height: .2f}") 
print(f"Mean values of earnings:{mean_earnings: .2f}") 
...
def draw_scatterplot(dataframe, x_column, y_column):
    ...
    plt.scatter(dataframe[x_column], dataframe[y_column], alpha = 0.5) # 0.5 = semi transparent markers
